...
* The original package name 'com.example.email-service' is invalid and this project uses 'com.example.email_service' instead.
...
* [Java Mail Sender](https://docs.spring.io/spring-boot/3.5.9/reference/io/email.html)
